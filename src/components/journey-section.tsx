...
export function JourneySection() {
  ...
  // CORRECTION DÉFINITIVE : On supprime le 'ease' pour éviter le conflit TypeScript
  const itemVariants = {
  ...
  return (
    <motion.div ref={ref} className="w-full" variants={containerVariants} initial="hidden" animate={controls}>
      <motion.h2 className="text-3xl font-bold text-center mb-12" variants={itemVariants}>
        {t("journey.sectionTitle")}
      </motion.h2>

      <motion.div className="grid grid-cols-1 lg:grid-cols-2 gap-16" variants={itemVariants}>
